...
- Name: api/api-validation.spec.js >> M8 — API & Network Validation >> TC01 — Login API endpoint returns successful response @smoke @critical
- Location: tests/api/api-validation.spec.js:15:3
