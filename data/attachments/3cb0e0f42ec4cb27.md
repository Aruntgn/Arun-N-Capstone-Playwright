...
- Name: api/api-validation.spec.js >> M8 — API & Network Validation >> TC06 — Login page loads without critical console errors @sanity
- Location: tests/api/api-validation.spec.js:100:3
