...
- Name: api/api-validation.spec.js >> M8 — API & Network Validation >> TC07 — Static assets load with 200 status on login page @sanity
- Location: tests/api/api-validation.spec.js:115:3
